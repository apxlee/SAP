...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Access_Details_Form]([parentId],[label],[description],[isActive],[isRequired])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Access_Details_Form]([parentId],[label],[description],[isActive],[isRequired])
VALUES(1,'Linux/Unix Servers','<p>Please provide a list of the servers you require access to, including domain name, and specify access type: Standard, Sudo (to a specific group or user), or Root privilege.&nbsp;&nbsp;<em>NOTE: All access will be provisioned via a domain-specific “a.account” which will be created for you as required.</em></p><p><a href="#" class="tooltip" rel="images/example_linuxunix_1.png">Example 1</a></p>',1,1)
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Access_Details_Form]([parentId],[label],[description],[isActive],[isRequired])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Actor_Group]([groupName],[description],[actorGroupType],[isLargeGroup],[isActive])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Actor_Group_Type]([pkId],[typeName])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Request_State_Type]([pkId],[typeName])
VALUES(0,'open')
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Request_State_Type]([pkId],[typeName])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Comments_Type]([pkId],[typeName],[audience])
...
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Workflow_State_Type]([pkId],[typeName])
VALUES(0,'approved')
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Workflow_State_Type]([pkId],[typeName])
VALUES(1,'change requested')
INSERT INTO [BPS_SupplementalAccess].[dbo].[SNAP_Workflow_State_Type]([pkId],[typeName])
