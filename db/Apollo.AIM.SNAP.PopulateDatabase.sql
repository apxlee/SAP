...
INSERT INTO [Apollo.AIM.SNAP].[dbo].[SNAP_Access_Details_Form]([parentId],[label],[description],[isActive],[isRequired])
VALUES(1,'Windows Servers/Role Membership','<p>Please provide a list of the servers you require access to, including domain name, and specify access type: Remote Desktop (RDP) or Administrator.&nbsp;&nbsp;<em>NOTE: Administrative Access includes RDP.</em></p><p><a href="#" class="tooltip" rel="images/example_windows_1.png">Example 1</a>&nbsp;&nbsp;<a href="#" class="tooltip" rel="images/example_windows_2.png">Example 2</a></p>',1,1)
INSERT INTO [Apollo.AIM.SNAP].[dbo].[SNAP_Access_Details_Form]([parentId],[label],[description],[isActive],[isRequired])
