<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowBladeSectionHeading.ascx.cs" Inherits="Apollo.AIM.SNAP.Web.Controls.WorkflowBladeSectionHeading" %>
