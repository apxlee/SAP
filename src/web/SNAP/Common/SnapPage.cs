...
namespace Apollo.AIM.SNAP.Web.Common
{
	public class SnapPage : Page
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			Logger.Info(WebUtilities.GetTimestamp() + "SnapPage > currentPageName (27): " + currentPageName + "\r\n"); // TODO REMOVE
			...
			if (!SnapSession.IsUserCreated)
			{
				if (currentPageName != PageNames.DEFAULT_LOGIN.ToLower() 
					...
					&& currentPageName != PageNames.APP_ERROR.ToLower() )
					{
						...
						Logger.Info(WebUtilities.GetTimestamp() + "SnapPage > redirecting to DEFAULT_LOGIN (43) from: " + currentPageName + "\r\n"); //TODO REMOVE
					}
			}
